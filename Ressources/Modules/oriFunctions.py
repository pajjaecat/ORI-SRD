...
def combineRnnPred(model_Vrise_dict,
    ...
    new_p0100_df = ctrlHvProd_model1_out.loc[mask_per2work, ['P0100']]
    ...
    new_p0100_df[vrise_true_mask] = ctrlHvProd_model1_out.loc[mask_per2work].loc[vrise_true_mask, ['P0100']]
